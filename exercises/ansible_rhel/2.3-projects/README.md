...
- **SCM UPDATE OPTIONS:** Tick three boxes "CLEAN", "DELETE ON UPDATE" and "UPDATE REVISION ON LAUNCH" to always get a fresh copy of the repository and to update the repository when launching a job.
