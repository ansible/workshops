...
Next, we need to add the tasks where the actual changes on the target machines are done. In this case, this happens in three steps:  
1. create a source object
2. create a destination object 
3. create the access rule between those two objects
