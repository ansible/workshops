...
![Controller URL example](images/controller_url.png?style=centreme)
...
![Automation controller dashboard](images/controller_dashboard.png?style=centreme)
...
![Blacklist attacker](images/controller_blacklist.png?style=centreme)
...
![Check Point logs view, violation logs](images/smartconsole_violation_logs.png?style=centreme)
...
![Check Point logs view, auto refresh button](images/smartconsole_auto_refresh.png?style=centreme)
...
![QRadar Log Activity showing logs from Check Point](images/qradar_checkpoint_logs.png?style=centreme)
...
![QRadar Log Sources](images/qradar_log_sources.png?style=centreme)
...
![QRadar Pre-configured Rules](images/qradar_preconfigured_rules.png?style=centreme)
...
![QRadar Rules Wizard](images/qradar_rule_wizard.png?style=centreme)
...
![Automation controller survey](images/controller_snort_survey.png?style=centreme)
