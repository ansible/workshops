...
Dans cet environnement, les playbooks sont stockés dans un référentiel git disponible sur l'instance Gitea de l'atelier. Avant qu'un **Projet** puisse être créé dans Automation Controller, l'URL git du référentiel est nécessaire. Pour obtenir l'URL de votre projet, connectez-vous à l'instance Gitea, sélectionnez votre projet d'atelier et copiez l'URL `https` présentée après avoir cliqué sur le bouton *Cloner*.
