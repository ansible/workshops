演習1 Ansible Towerの概要と構成  
=========================

Ansible Tower には、マルチテナンシー、通知、スケジューリングなどを可能にする多くの構成要素があります。ここでは、今日このワークショップに必要ないくつかの重要な構成要素にのみに焦点を当ててご説明します。Ansible Engine でおなじみの構成要素もありますし、Ansible Tower 独自のものもあります。♬  
